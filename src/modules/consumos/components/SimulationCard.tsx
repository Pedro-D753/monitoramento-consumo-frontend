...
export function SimulationCard({
  simulation,
  dailyRate,
  headerColor = theme.colors.primary.main,
  onEdit,
  onDelete,
}: SimulationCardProps) {
    ...
    <View style={styles.card}>
      <View style={[styles.cardHeader, { backgroundColor: headerColor }]}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Typography variant="regular" size="xs" color="rgba(255,255,255,0.8)">
...
const styles = StyleSheet.create({
  ...
  confirmRow: {
    ...
    borderTopColor: theme.colors.border, flexDirection: 'row',
