...
import { SignUpStep2Data, signUpStep2Schema } from '@/modules/auth/schemas/signUpSchema';
    ...
    return (
        ...
        footer={
            ...
            <View style={styles.card}>
                <Typography variant="bold" size="md" style={styles.title2}>Crie seu Nome de Usuário!</Typography>
